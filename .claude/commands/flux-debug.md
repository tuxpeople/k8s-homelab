...
- **Generated Manifests**: Most files generated by makejinja
- **Source Templates**: Edit `templates/` directory, then `task configure`
- **Validation**: Use `task validate-schemas` after changes
