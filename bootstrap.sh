...
ssh lab1 -l root "kvm-install-vm attach-disk -d 80 -s longhorn-80g.qcow2 -t vdb k3s-node1"
ssh lab2 -l root "kvm-install-vm attach-disk -d 80 -s longhorn-80g.qcow2 -t vdb k3s-node2"
ssh lab3 -l root "kvm-install-vm attach-disk -d 80 -s longhorn-80g.qcow2 -t vdb k3s-node3"
ssh lab4 -l root "kvm-install-vm attach-disk -d 80 -s longhorn-80g.qcow2 -t vdb k3s-node-a"
