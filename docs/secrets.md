...
2. **Secret ändern**: `sops path/to/secret.sops.yaml` und anschließend `task encrypt-secrets`, falls mehrere Dateien betroffen sind.
...
- ✅ `kubectl get externalsecret -A` regelmäßig prüfen.
