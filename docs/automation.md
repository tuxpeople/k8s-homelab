...
-   `task pre-commit:run` bei grösseren Refactorings oder bevor Renovate-PRs gemergt werden.
-   Verstösse → Commit blockiert, daher ggf. `pre-commit run --all-files` frühzeitig laufen lassen.
